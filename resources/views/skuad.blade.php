            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <a href="/">
                                <img src="https://skuad.adk.gov.my/img/logo.png" style="text-align:center;"
                                    alt="" width="200">
                            </a>
                        </h1>
                    </div>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <h1 class="hero-title mt-0 is-revealing">SKUAD ANTIDADAH</h1>
                            <p class="hero-paragraph is-revealing">Hub Sukarelawan Antidadah, Agensi Antidadah
                                Kebangsaan</p>
                            <div class="hero-form field field-grouped is-revealing">
                                <div class="control">
                                    <a class="button button-primary" href="https://skuad.adk.gov.my/s/login">Log
                                        Masuk</a>
                                    <a class="button button-secondary"
                                        href="https://skuad.adk.gov.my/s/pendaftaran">Daftar Ahli</a>
                                </div>
                            </div>
                        </div>
                        <div class="hero-illustration">
                            <div class="hero-bg">
                                <svg width="720" height="635" xmlns="http://www.w3.org/2000/svg">
                                    <defs>
                                        <linearGradient x1="50%" y1="0%" x2="50%" y2="97.738%"
                                            id="a">
                            ...
                            <div class="hero-square hero-square-4 is-moving-object is-rotating">
                                <svg width="320" height="320" xmlns="http://www.w3.org/2000/svg">
                                    <defs>
                                        ...
                                        <linearGradient x1="0%" y1="57.64%" x2="94.346%" y2="8.32%"
                                            id="square-4-c">
                                            <stop stop-color="#43F1FF" stop-opacity=".24" offset="0%" />
                                            <stop stop-color="#43F1FF" stop-opacity=".16" offset="100%" />
                                        </linearGradient>
                                        <radialGradient cx="100%" cy="100%" fx="100%" fy="100%"
                                            r="136.8%" id="square-4-d">
                                            <stop stop-color="#43F1FF" offset="0%" />
                                            <stop stop-color="#43F1FF" stop-opacity="0" offset="100%" />
                                        </radialGradient>
                                        <radialGradient cx="100%" cy="100%" fx="100%" fy="100%"
                                            r="140.264%" id="square-4-e">
                                            <stop stop-color="#43F1FF" offset="0%" />
                                            <stop stop-color="#43F1FF" stop-opacity="0" offset="100%" />
                                        </radialGradient>
                                        <radialGradient cx="100%" cy="100%" fx="100%" fy="100%"
                                            r="137.638%" id="square-4-f">
                                            <stop stop-color="#43F1FF" offset="0%" />
                                            <stop stop-color="#43F1FF" stop-opacity="0" offset="100%" />
                                        </radialGradient>
                                    </defs>
                                    <g fill="none" fill-rule="evenodd">
                                        <rect fill="url(#square-4-a)" width="320" height="320"
                                            rx="2" />
                                        <path
                            ...
                            <div class="hero-square hero-square-6 is-moving-object is-rotating">
                                <svg width="128" height="128" xmlns="http://www.w3.org/2000/svg">
                                    <defs>
                                        ...
                                        <linearGradient x1="97.033%" y1="97.033%" x2="0%" y2="0%"
                                            id="square-6-c">
                                            <stop stop-color="#43F1FF" offset="0%" />
                            ...
                            <div class="hero-square hero-square-7 is-moving-object is-rotating">
                                <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg">
                                    <defs>
                                        ...
                                        <radialGradient cx="-5.754%" cy="67.691%" fx="-5.754%" fy="67.691%"
                                            r="140.869%"
                                        ...
                                        <linearGradient x1="0%" y1="23.176%" x2="96.787%" y2="88.669%"
                                            id="square-7-c">
                                            <stop stop-color="#43F1FF" stop-opacity="0" offset="0%" />
        ...
        <footer class="site-footer">
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    <div class="footer-copyright">&copy; 2012 - 2024 Skuad, Semua Hakcipta Terpelihara</div>
                </div>
            </div>
        </footer>
    </div>

    <script src="https://skuad.adk.gov.my/dist/js/main.min.js"></script>
</body>
